...
Figtree offers many more functions that you should explore in detail. Publication-ready figures can be generated, or further modified in e.g., a vector graphics programme such as [Inkscape](https://inkscape.org/). A good alternative to Figtree is iTol (Interactive Tree of Life), an online platform that offers a similar set of tools as Figtree: [https://itol.embl.de/](https://itol.embl.de/). 
