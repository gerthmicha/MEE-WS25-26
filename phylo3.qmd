...
```{bash eval = F}
iqtree -s COI_aligned.fas -pre COI_ML -m GTR+F+I+G4 -bb 1000
```
...
| `-b 100`     | This is the standard, non-parametric bootstrap – long computation times, but useful in some cases. 
